...
print("\n=== STEP 3: Standardized Variables (Quantifiers Dropped) ===")
for key, val in CNF_imp_removed.items():
    print(f"{key}. {val}")
...
steps = [
    ...
    ("2", "Resolve (1) with (¬food(x) ∨ likes(John, x)) using substitution {x/Peanuts}", "¬food(Peanuts)"),
...
print("Conclusion: Contradiction reached ⇒ Therefore, the statement 'John likes Peanuts' is TRUE.\n")
